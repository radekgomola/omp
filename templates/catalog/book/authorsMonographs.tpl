...
{if $count>0}
    <div class="pkp_catalog_monographs" id="monographListContainer" style="margin-top:25px">
        ...
        <ul class="pkp_helpers_clear" style="margin-left: 5px;">
            ...
            <li class="pkp_catalog_monograph pkp_helpers_align_left" style="min-height: 180px;">
