...
{foreach from=$availableFiles[$publicationFormatId] item=availableFile}{* There will be at most one of these *}
        <li>    
            ...
            <div class="publicationFormatLink">
                ...
                {if $calameoHash}
                    <a href="//v.calameo.com/?bkcode={$calameoHash}" {literal}onclick="return hs.htmlExpand(this, {objectType: 'iframe'});"{/literal}><img src="{$baseUrl}/images/design/flash_player_logo.png" />FlipBook</a>
                {/if}
                <a href="{$downloadUrl}">
