...
class PdfJsViewerPlugin extends ViewableFilePlugin {
	...
	function displaySubmissionFile($publishedMonograph, $publicationFormat, $submissionFile) {
		...
		$templateMgr->assign(array(
			...
			'downloadUrl' => $dispatcher->url($request, ROUTE_PAGE, null, null, 'download', array($publishedMonograph->getBestId(), $publicationFormat->getBestId(), $submissionFile->getBestId()), array('inline' => false)),
		));
