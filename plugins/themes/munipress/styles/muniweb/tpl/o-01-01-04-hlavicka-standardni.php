...
?>
	...
	<div class="sk-example">
		<div class="row-main">
			<div class="sk-annot">
				<h2 class="sk-annot__title">Jen se sekundárním menu</h2>
			</div>
			<div class="sk-example__comment">
				...
				<p>
					 <strong>V tomto případě menu obsahuje pouze sekundární část zarovnanou doleva</strong>. Na header__menu__secondary se přidává modifikátor header__menu__secondary--left
				</p>
				<p>
