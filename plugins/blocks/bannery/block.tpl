...
<div style="padding-left: 5px;">	
    ...
    <div><a href="{$baseUrl}/public/download_files/Katalog2014jaro.pdf" target="_blank"><img src="{$baseUrl}/images/img/bannery/04.png" class="link_img bannery" /></a></div>
    <div><a href="http://en.calameo.com/read/0039505795a5a83938c25" target="_blank"><img src="{$baseUrl}/images/img/bannery/04.png" class="link_img bannery" /></a></div>
  </div>
</div>