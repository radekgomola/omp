...
class CitationPlugin extends Plugin {
	 ...
	 * templates/citace/captureCite.tpl template, which ships with OJS.
	 */
	 ...
	 * @param $press object
	 */
	function displayCitation(&$submission, &$press) {
		HookRegistry::register('Template::citace::CaptureCite', array(&$this, 'displayCitationHook'));
		$templateMgr =& TemplateManager::getManager();
		$templateMgr->assign_by_ref('citationPlugin', $this);
		$templateMgr->assign_by_ref('submission', $submission);
		$templateMgr->assign_by_ref('press', $press);
		$templateMgr->display('citace/captureCite.tpl');
	}
	 ...
	 * @param $press object
	 */
	function fetchCitation(&$submission, &$press) {
		$templateMgr =& TemplateManager::getManager();
		$templateMgr->assign_by_ref('citationPlugin', $this);
		$templateMgr->assign_by_ref('submission', $submission);
		$templateMgr->assign_by_ref('press', $press);
