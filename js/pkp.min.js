...
a.pkp.controllers.modals.submissionMetadata.MonographlessCatalogEntryHandler.prototype.showFetchedMetadataForm_=function(c,b){var d=this.handleJson(b),e=a("#metadataFormContainer");e.children().remove();e.append(d.content)}})(jQuery);(function(a){a.pkp.controllers.grid.files=a.pkp.controllers.grid.files||{proof:{form:{}}};a.pkp.controllers.grid.files.proof.form.ApprovedProofFormHandler=function(c,b){this.parent(c,b);this.salesType_=b.salesType;c.find("#notAvailable, #openAccess, #directSales, #forRegistered").click(this.callbackWrapper(this.checkHandler_));var d=a('input[id^="price"]');d.on("change keyup paste",this.callbackWrapper(this.changeHandler_));""!==this.salesType_&&(""===d.attr("value")?(a("#notAvailable").attr("checked","true"),d.attr("disabled",
"true")):"0"===d.attr("value")?(a("#openAccess").attr("checked","true"),d.attr("disabled","true").attr("value","")):"-1"===d.attr("value")?(a("#forRegistered").attr("checked","true"),d.attr("disabled","true").attr("value","")):a("#directSales").attr("checked","true"))};a.pkp.classes.Helper.inherits(a.pkp.controllers.grid.files.proof.form.ApprovedProofFormHandler,a.pkp.controllers.form.AjaxFormHandler);a.pkp.controllers.grid.files.proof.form.ApprovedProofFormHandler.prototype.salesType_=null;a.pkp.controllers.grid.files.proof.form.ApprovedProofFormHandler.prototype.checkHandler_=function(c){var b=a('input[id^="price"]');
